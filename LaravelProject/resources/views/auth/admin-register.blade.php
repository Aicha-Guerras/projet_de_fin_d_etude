            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.register.submit') }}">
                        ...
                        <div class="form-group row">
                            <label for="dateDeNaissance" class="col-md-4 col-form-label text-md-right">{{ __('Date de Naissance') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pays" type="text" class="form-control @error('pays') is-invalid @enderror" name="pays" value="{{ old('pays') }}" required autocomplete="prenom" autofocus>
